...
outputFile: '{output_folder}/psm-artifacts/security-audit-{{date}}.md'
---
...
"📋 **Workflow Resume — PSM Security Audit (SA001)**

**Last saved:** {lastSaved}
**Steps completed:** {stepsCompleted.length} of 3

1. step-01-scope (Define Scope) — {✅ if in stepsCompleted, ⬜ otherwise}
2. step-02-audit (Security Audit) — {✅ if in stepsCompleted, ⬜ otherwise}
3. step-03-report (Final Report) — {✅ if in stepsCompleted, ⬜ otherwise}"
...
- `'step-01-scope'` → Load `./step-02-audit.md`
- `'step-02-audit'` → Load `./step-03-report.md`
- `'step-03-report'` → **Workflow already complete.** Display: "✅ **All steps completed.** Use **[V] Validate** to review outputs or **[E] Edit** to make revisions." Then halt.

...
```yaml
---
stepsCompleted: ["step-01-scope.md", "step-02-audit.md"]
lastStep: "step-03-report.md"
...
Steps Completed:
  1. Step 01: Scope & Threat Model (scope, threat actors, compliance)
  2. Step 02: Security Assessment (5 domains scored)
  3. Step 03: Final Report (findings, remediation, sign-off)
...
**Next Steps**:
1. Share security audit report with all stakeholders
2. If conditional approval: ensure all conditions are tracked and monitored
3. If blocked: schedule follow-up audit once findings are resolved
4. Track remediation progress per the roadmap

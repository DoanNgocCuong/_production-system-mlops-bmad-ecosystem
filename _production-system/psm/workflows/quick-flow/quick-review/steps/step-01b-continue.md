...
"📋 **Workflow Resume — PSM Quick Review (QR001)**

**Last saved:** {lastSaved}
**Steps completed:** {stepsCompleted.length} of 2

1. step-01-context (Load Context) — {✅ if in stepsCompleted, ⬜ otherwise}
2. step-02-review (Review) — {✅ if in stepsCompleted, ⬜ otherwise}"
...
- `'step-01-context'` → Load `./step-02-review.md`
- `'step-02-review'` → **Workflow already complete.** Display: "✅ **All steps completed.** Use **[V] Validate** to review outputs or **[E] Edit** to make revisions." Then halt.

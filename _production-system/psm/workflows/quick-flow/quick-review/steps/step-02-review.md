...
This is the **FINAL STEP** of the Quick Review workflow.

```
"Quick review complete!

Steps Completed:
  1. Step 01: Review Context (scope, checklist loaded)
  2. Step 02: Apply Checklist (findings, recommendations)

Overall Assessment: [documented]
CRITICAL Issues: [listed]
HIGH Priority Items: [listed]
Effort to Address: [estimated]

Quick Review Workflow: COMPLETE"
```

**Next Steps**:
1. Share review report with the team
2. Assign action items to respective owners
3. Schedule follow-up review after fixes applied
4. Block production deployment until CRITICAL items resolved

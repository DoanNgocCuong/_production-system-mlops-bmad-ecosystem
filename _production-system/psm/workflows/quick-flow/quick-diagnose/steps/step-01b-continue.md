...
"📋 **Workflow Resume — PSM Quick Diagnose (QD001)**

**Last saved:** {lastSaved}
**Steps completed:** {stepsCompleted.length} of 2

1. step-01-gather (Gather Information) — {✅ if in stepsCompleted, ⬜ otherwise}
...
- `'step-01-gather'` → Load `./step-02-diagnose.md`
- `'step-02-diagnose'` → **Workflow already complete.** Display: "✅ **All steps completed.** Use **[V] Validate** to review outputs or **[E] Edit** to make revisions." Then halt.

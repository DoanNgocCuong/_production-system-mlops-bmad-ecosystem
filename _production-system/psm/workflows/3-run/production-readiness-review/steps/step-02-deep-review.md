...
```yaml
---
stepsCompleted: ["step-01-init-checklist.md"]
lastStep: "step-02-deep-review.md"
...
**Select an Option:**
**[C] Continue to step-03-final-decision.md**
**[A] Advanced Elicitation**
**[P] Party Mode**
**[Y] YOLO**

Menu Handling:
- IF C: Update frontmatter (add this step to stepsCompleted, update lastStep, lastSaved), save document, then read fully and follow `./step-03-final-decision.md`

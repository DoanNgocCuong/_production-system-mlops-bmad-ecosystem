...
outputFile: '{output_folder}/psm-artifacts/prr-{{service_name}}-{{date}}.md'
---
...
"📋 **Workflow Resume — PSM Production Readiness Review (PRR001)**

**Last saved:** {lastSaved}
**Steps completed:** {stepsCompleted.length} of 3

1. step-01-init-checklist (Initial Checklist) — {✅ if in stepsCompleted, ⬜ otherwise}
2. step-02-deep-review (Deep Review) — {✅ if in stepsCompleted, ⬜ otherwise}
3. step-03-final-decision (Final Decision) — {✅ if in stepsCompleted, ⬜ otherwise}"
...
- `'step-01-init-checklist'` → Load `./step-02-deep-review.md`
- `'step-02-deep-review'` → Load `./step-03-final-decision.md`
- `'step-03-final-decision'` → **Workflow already complete.** Display: "✅ **All steps completed.** Use **[V] Validate** to review outputs or **[E] Edit** to make revisions." Then halt.

...
```yaml
---
stepsCompleted: ["step-01-triage.md", "step-02-diagnose.md"]
lastStep: "step-03-fix.md"
...
**Select an Option:**
**[C] Continue to step-04-postmortem.md**
**[A] Advanced Elicitation**
**[P] Party Mode**
**[Y] YOLO**

Menu Handling:
- IF C: Update frontmatter (add this step to stepsCompleted, update lastStep, lastSaved), save document, then read fully and follow `./step-04-postmortem.md`

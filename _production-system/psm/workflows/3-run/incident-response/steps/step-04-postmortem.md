...
```yaml
---
stepsCompleted: ["step-01-triage.md", "step-02-diagnose.md", "step-03-fix.md"]
lastStep: "step-04-postmortem.md"
...
This is the **FINAL STEP** of the Incident Response workflow.

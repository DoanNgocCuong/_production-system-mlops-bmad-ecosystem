...
outputFile: '{output_folder}/psm-artifacts/architecture-review-{{date}}.md'
---
...
"📋 **Workflow Resume — PSM Architecture Review (RA001)**

**Last saved:** {lastSaved}
**Steps completed:** {stepsCompleted.length} of 3

1. step-01-context (Load Context) — {✅ if in stepsCompleted, ⬜ otherwise}
2. step-02-analysis (Architecture Analysis) — {✅ if in stepsCompleted, ⬜ otherwise}
3. step-03-recommendations (Recommendations) — {✅ if in stepsCompleted, ⬜ otherwise}"
...
- `'step-01-context'` → Load `./step-02-analysis.md`
- `'step-02-analysis'` → Load `./step-03-recommendations.md`
- `'step-03-recommendations'` → **Workflow already complete.** Display: "✅ **All steps completed.** Use **[V] Validate** to review outputs or **[E] Edit** to make revisions." Then halt.

...
is_final_step: false
outputFile: "{project-root}/psm/outputs/setup-new-service/{service_name}/architecture-design-document.md"
...
---
stepsCompleted: []
lastStep: "step-01-architecture.md"
...
**Select an Option:**
**[C] Continue to step-02-api-database.md**
**[A] Advanced Elicitation**
**[P] Party Mode**
**[Y] YOLO**

Menu Handling:
- IF C: Update frontmatter (add this step to stepsCompleted, update lastStep, lastSaved), save document, then read fully and follow `./step-02-api-database.md`

...
skill_loads:
  - "references/5.11 - CROSS - Security/SKILL.md"
  - "references/5.12 - CROSS - Configuration & Secrets/SKILL.md"
  - "references/5.13 - CROSS - Infrastructure & Containerization/SKILL.md"
is_final_step: false
outputFile: "{project-root}/psm/outputs/setup-new-service/{service_name}/security-plan.md"
...
```
Load: references/5.11 - CROSS - Security/SKILL.md
      → Authentication, authorization, OWASP top 10

Load: references/5.12 - CROSS - Configuration & Secrets/SKILL.md
      → Environment variables, secrets, ConfigMaps, SealedSecrets

Load: references/5.13 - CROSS - Infrastructure & Containerization/SKILL.md
...
```yaml
---
stepsCompleted: ["step-01-architecture.md", "step-02-api-database.md", "step-03-build-deploy.md", "step-04-reliability.md"]
lastStep: "step-05-security-infra.md"
...
**Select an Option:**
**[C] Continue to step-06-readiness.md**
**[A] Advanced Elicitation**
**[P] Party Mode**
**[Y] YOLO**

Menu Handling:
- IF C: Update frontmatter (add this step to stepsCompleted, update lastStep, lastSaved), save document, then read fully and follow `./step-06-readiness.md`

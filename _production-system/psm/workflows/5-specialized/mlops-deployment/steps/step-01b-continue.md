...
outputFile: '{output_folder}/psm-artifacts/mlops-deployment-{{model_name}}-{{date}}.md'
---
...
"📋 **Workflow Resume — PSM MLOps Deployment (ML001)**

**Last saved:** {lastSaved}
**Steps completed:** {stepsCompleted.length} of 3

1. step-01-model-validation (Model Validation) — {✅ if in stepsCompleted, ⬜ otherwise}
2. step-02-deploy (Deploy) — {✅ if in stepsCompleted, ⬜ otherwise}
3. step-03-monitor (Monitor) — {✅ if in stepsCompleted, ⬜ otherwise}"
...
- `'step-01-model-validation'` → Load `./step-02-deploy.md`
- `'step-02-deploy'` → Load `./step-03-monitor.md`
- `'step-03-monitor'` → **Workflow already complete.** Display: "✅ **All steps completed.** Use **[V] Validate** to review outputs or **[E] Edit** to make revisions." Then halt.

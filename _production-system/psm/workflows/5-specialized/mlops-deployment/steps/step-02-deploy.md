...
```yaml
---
stepsCompleted: ["step-01-model-validation.md"]
lastStep: "step-02-deploy.md"
...
**Select an Option:**
**[C] Continue to step-03-monitor.md**
**[A] Advanced Elicitation**
**[P] Party Mode**
**[Y] YOLO**

Menu Handling:
- IF C: Update frontmatter (add this step to stepsCompleted, update lastStep, lastSaved), save document, then read fully and follow `./step-03-monitor.md`

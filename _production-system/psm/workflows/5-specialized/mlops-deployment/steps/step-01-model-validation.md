...
---
stepsCompleted: []
lastStep: "step-01-model-validation.md"
...
**Select an Option:**
**[C] Continue to step-02-deploy.md**
**[A] Advanced Elicitation**
**[P] Party Mode**
**[Y] YOLO**

Menu Handling:
- IF C: Update frontmatter (add this step to stepsCompleted, update lastStep, lastSaved), save document, then read fully and follow `./step-02-deploy.md`

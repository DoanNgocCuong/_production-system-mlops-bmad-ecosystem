...
skill_loads:
  - "references/5.10 - PRODUCTION READINESS/SKILL.md"
  - "references/5.14 - DOCUMENTATION & RUNBOOKS/SKILL.md"
---
...
```
Load: references/5.10 - PRODUCTION READINESS/SKILL.md
      → Production readiness checklist, launch criteria

Load: references/5.14 - DOCUMENTATION & RUNBOOKS/SKILL.md
...
### [A] Accept readiness assessment
- Confirms PRR checklist completion
- Validates runbook & incident response
- APPROVED FOR PRODUCTION DEPLOYMENT

### [C] Continue refining
- Address remaining checklist items
...
After deployment, monitor these metrics continuously for 24 hours:

**Golden Signals**:
- Request rate: Normal traffic levels?
- Error rate: < 0.5%?
- Latency: p99 < target?
- Saturation: Resource usage normal?

**If ANY signal goes red during 24h window:**
1. Trigger incident response
2. Consider automatic rollback
3. Engage incident commander

**24h Checkpoint**: If all signals GREEN, mark as STABLE.

...
skill_loads:
  - "references/5.07 - RELIABILITY & RESILIENCE/SKILL.md"
  - "references/5.08 - OBSERVABILITY & MONITORING/SKILL.md"
  - "references/5.09 - ERROR HANDLING & RECOVERY/SKILL.md"
---
...
```
Load: references/5.07 - RELIABILITY & RESILIENCE/SKILL.md
      → Resilience patterns, circuit breaker, bulkhead

Load: references/5.08 - OBSERVABILITY & MONITORING/SKILL.md
      → Logging, metrics, tracing, alerting strategies

Load: references/5.09 - ERROR HANDLING & RECOVERY/SKILL.md

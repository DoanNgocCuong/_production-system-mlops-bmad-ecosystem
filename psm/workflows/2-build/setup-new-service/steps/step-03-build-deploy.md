...
skill_loads:
  - "references/5.04 - DEPLOYMENT & INFRASTRUCTURE/SKILL.md"
  - "references/5.05 - TESTING STRATEGY/SKILL.md"
  - "references/5.06 - CODE QUALITY & STANDARDS/SKILL.md"
---
...
```
Load: references/5.04 - DEPLOYMENT & INFRASTRUCTURE/SKILL.md
      → CI/CD platforms, deployment strategies, blue-green, canary

Load: references/5.05 - TESTING STRATEGY/SKILL.md
      → Testing pyramid, test ratios, coverage targets, E2E frameworks

Load: references/5.06 - CODE QUALITY & STANDARDS/SKILL.md
